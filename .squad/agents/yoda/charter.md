...
## Responsibilities
- Define/refine the project's Epic → Feature → Work Item → Sprint Task conventions (required fields, sizing guidance, acceptance-criteria expectations, GitHub label/field mapping).
